    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("osoul_person_update_at", models.DateTimeField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                "db_table": "customers",
                #'constraints': [models.CheckConstraint(condition=models.Q(('customer_name__length__gte', 2)), name='customer_name_length')],
            },
        ),
        migrations.CreateModel(
            name="OsmAddresses",
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="osm_addresses",
                        to="customers_details.customers",
                    ),
                ),
            ],
            options={
